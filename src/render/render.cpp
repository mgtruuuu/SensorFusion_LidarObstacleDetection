...
void renderHighway(pcl::visualization::PCLVisualizer::Ptr& viewer) {
	...
	viewer->addCube(static_cast<float>(-roadLength / 2), static_cast<float>(roadLength / 2), static_cast<float>(-roadWidth / 2), static_cast<float>(roadWidth / 2), static_cast<float>(-roadHeight), 0.0f, .2, .2, .2, "highwayPavement");
	...
	viewer->addLine(
		pcl::PointXYZ{ static_cast<float>(-roadLength / 2), static_cast<float>(-roadWidth / 6), 0.01f },
		pcl::PointXYZ{ static_cast<float>(roadLength / 2), static_cast<float>(-roadWidth / 6), 0.01f },
		1.0, 1.0, 0.0, "line1");
	viewer->addLine(
		pcl::PointXYZ(static_cast<float>(-roadLength / 2), static_cast<float>(roadWidth / 6), 0.01f),
...
void renderBox(
	pcl::visualization::PCLVisualizer::Ptr& viewer,
	Box box, int id, Color color, float opacity) {
...
void renderBox(
	pcl::visualization::PCLVisualizer::Ptr& viewer, 
	BoxQ box, int id, Color color, float opacity) {
